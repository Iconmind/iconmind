...
export default function ComparesPage() {
  return (
    <div className="mx-auto max-w-[900px] px-5 pt-14 pb-24 sm:px-7">
      ...
      <p className="mt-3 max-w-[62ch] text-lead text-ink-2">The sets people already know, next to this one. Measured facts either side would sign, and the case for each.</p>
