...
import { Agent, Llm, VectorDatabase } from "./generated/index";
...
describe("props", () => {
  it("applies size, color and strokeWidth", () => {
    const m = render(h(Llm, { size: 32, color: "#f00", strokeWidth: 1.5 }));
  ...
  it("keeps stroke visually constant with absoluteStrokeWidth", () => {
    ...
    const m = render(h(VectorDatabase, { size: 48, absoluteStrokeWidth: true }));
