...
2,437 SVG icons for AI-era software — LLMs, agents, MCP, RAG, and everything around
...
```js
// one file per cell
import agent from "@iconmind/icons/icons/agents/agent/outline-regular.svg";

// metadata for search and tooling
