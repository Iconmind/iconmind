...
<p align="center">
  ...
  <img alt="icons" src="https://img.shields.io/badge/icons-2437-black">
  <img alt="cells" src="https://img.shields.io/badge/SVGs-14622-black">
...
**2,437 icons · 14,622 drawings · 10 packages · one generated source of truth.**

Every icon is a declaration compiled into six cells by a validator that refuses geometry
it cannot draw correctly, and a nightly job rasterises all 14,622 of them and fails if any
...
**2,437 icons · 12 domains · 6 cells each.** Two variants, outline and duotone, each
...
pnpm icons:twins                  # renders all 2,437 icons and pixel-compares every pair for lookalikes
pnpm icons:duplicates --perceptual # the nightly scan: 14,622 cells, fails on two that render alike
```
...
**Why only 0/45/90° angles?** It is the constraint that makes 2,437 icons read as one
