...
<p align="center">
  ...
  <img alt="icons" src="https://img.shields.io/badge/icons-3287-black">
  <img alt="cells" src="https://img.shields.io/badge/SVGs-19722-black">
...
**3,287 icons · 19,722 drawings · 10 packages · one generated source of truth.**

Every icon is a declaration compiled into six cells by a validator that refuses geometry
it cannot draw correctly, and a nightly job rasterises all 19,722 of them and fails if any
...
**3,287 icons · 12 domains · 6 cells each.** Two variants, outline and duotone, each
...
pnpm icons:twins                  # renders all 3,287 icons and pixel-compares every pair for lookalikes
pnpm icons:duplicates --perceptual # the nightly scan: 19,722 cells, fails on two that render alike
```
...
```bash
pnpm icons:validate                # every rule, all 19,722 cells
...
**Why only 0/45/90° angles?** It is the constraint that makes 3,287 icons read as one
