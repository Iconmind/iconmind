...
**1,041 icons · 6,246 drawings · 10 packages · one generated source of truth.**
...
**1,041 icons · 12 domains · 6 cells each.** Two variants — outline and duotone — each
...
**Why only 0/45/90° angles?** It is the constraint that makes 1,041 icons read as one
