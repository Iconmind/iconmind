...
Reviews here judge **the icon, not the person**. Feedback on a submission should
always name the specific rule, explain why, and offer a next step. "This doesn't
work" is not acceptable review.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported
to the maintainers at **conduct@iconmind.dev**. All complaints will be reviewed and
