...
export const BATCH_129: Icon[] = [
  ...
  c("jump-rope", "Skipping rope", "The rope swung under the feet",
    ...
    "rope", [arc(12, 10, 8, 0, 180), disc(4, 8, 2), disc(20, 8, 2)]),
  ...
  c("personal-trainer", "Personal trainer", "A person with the session written down",
    ["trainer", "coach", "session"], [], ["personal trainer", "coach", "PT session", "trainer"],
    "person", [disc(7, 7, 3), arc(7, 16, 4.5, 180, 360), rect(13, 8, 8, 11, 2), row(12, 15, 19), row(15, 15, 19)]),
  ...
  c("activity-ring", "Activity ring", "One ring closing round another",
    ...
    "ring", [arc(12, 12, 9, 90, 360), arc(12, 12, 5.5, 270, 180)]),
