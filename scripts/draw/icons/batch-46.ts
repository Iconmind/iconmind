...
export const BATCH_46: Icon[] = [
...

  {
    ...
    name: "Code namespace", description: "Names that belong together",
  ...
  },
  {
    ...
    name: "Kubernetes namespace", description: "A fenced part of the cluster",
  ...
  },
  {
    ...
    name: "Cluster namespace", description: "One name over many machines",
  ...
  },
  {
    ...
    name: "Node cluster", description: "Machines acting as one",
...

  {
    ...
    name: "RAG pipeline", description: "Retrieve, then write with what you found",
  ...
  },
  {
    ...
    name: "Ingestion pipeline", description: "Documents in, index entries out",
  ...
  },
  {
    ...
    name: "Transform step", description: "The stage that changes the shape",
...

  {
    ...
    name: "Quality", description: "Good enough to trust",
  ...
  },
  {
    ...
    name: "Safety check", description: "Looked at before it goes out",
  ...
  },
  {
    ...
    name: "Score card", description: "The number, big, and how it moved",
  ...
  },
  {
    ...
    name: "Relevance score", description: "How close this is to what was asked",
...

  {
    ...
    name: "Sample size", description: "How many you need before it means anything",
  ...
  },
  {
    ...
    name: "Sampling", description: "Pick from the maybes",
  ...
  },
  {
    ...
    name: "Cron schedule", description: "At these minutes, on these days",
...

  {
    ...
    name: "Source citation", description: "Chapter and verse for the claim",
  ...
  },
  {
    ...
    name: "Union", description: "Everything from both",
  ...
  },
  {
    ...
    name: "Join tables", description: "Matched where the keys agree",
  ...
  },
  {
    ...
    name: "Recursive split", description: "Halve it until the pieces fit",
...

  {
    ...
    name: "Priority", description: "This one before the others",
  ...
  },
  {
    ...
    name: "Unpin", description: "Let it move again",
  ...
  },
  {
    ...
    name: "Volume up", description: "Louder",
  ...
  },
  {
    ...
    name: "View", description: "Just looking",
