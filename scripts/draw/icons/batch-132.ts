...
export const BATCH_132: Icon[] = [
  ...
  c("nappy", "Nappy", "The nappy with its tabs",
    ...
    "nappy", [poly([[5, 8], [19, 8], [12, 15]], true), poly([[5, 8], [5, 5], [9, 5], [9, 8]]), poly([[15, 8], [15, 5], [19, 5], [19, 8]])]),
  ...
  /* ── access ─────────────────────────────────────────────────────────────────── */
  c("accessible", "Accessible", "The ramp with its handrail",
    ["access", "ramp", "step-free"], ["step-free"], ["accessible", "step free", "ramp", "access"],
    "ramp", [poly([[2, 18], [2, 13], [7, 13], [7, 8], [12, 8]]), poly([[12, 8], [19, 15]]), row(18, 2, 19), col(19, 15, 18)]),
  c("disability", "Disability", "The figure with a rail to hold",
    ["disability", "support", "aid"], [], ["disability", "disabled", "support", "mobility aid"],
    "figure", [disc(7, 5, 3), poly([[7, 8], [7, 14]]), poly([[2, 19], [7, 14], [12, 19]]), poly([[16, 7], [16, 20]]), poly([[16, 11], [21, 11]])]),
  ...
  c("face-mask", "Face mask", "The face with the mask over it",
    ["mask", "cover", "wear"], [], ["face mask", "wear a mask", "face covering", "mask on"],
    "face", [disc(12, 9, 6), raw("M3 12H21V15A12 12 0 0 1 3 15Z", "the mask over the mouth and chin", true), poly([[3, 12], [3, 8]]), poly([[21, 12], [21, 8]])]),
