...
export const BATCH_45: Icon[] = [
...

  {
    ...
    name: "Server", description: "The machine that answers",
  ...
  },
  {
    ...
    name: "Script", description: "Commands, saved for later",
  ...
  },
  {
    ...
    name: "Window", description: "One app's piece of the screen",
  ...
  },
  {
    ...
    name: "Widget", description: "A small thing that shows one thing",
  ...
  },
  {
    ...
    name: "Warehouse", description: "Everything, shelved and queryable",
  ...
  },
  {
    ...
    name: "Workspace", description: "Your desk, remembered",
...

  {
    ...
    name: "Version control", description: "Every change, kept",
  ...
  },
  {
    ...
    name: "Git tag", description: "A commit with a name on it",
  ...
  },
  {
    ...
    name: "Version bump", description: "One number up",
  ...
  },
  {
    ...
    name: "Mock", description: "Stands in for the real one",
  ...
  },
  {
    ...
    name: "Test run", description: "The suite, going",
...

  {
    ...
    name: "Transform", description: "In one shape, out another",
  ...
  },
  {
    ...
    name: "Stream job", description: "Always running, never done",
  ...
  },
  {
    ...
    name: "Training data", description: "What the model learned from",
...

  {
    ...
    name: "Request trace", description: "One call, followed all the way",
  ...
  },
  {
    ...
    name: "Top-p", description: "Enough choices to cover the odds",
  ...
  },
  {
    ...
    name: "Toggle", description: "On, or off",
  ...
  },
  {
    ...
    name: "Token auth", description: "The string that vouches for you",
...

  {
    ...
    name: "User journey", description: "Every step they took",
  ...
  },
  {
    ...
    name: "User prompt", description: "What the person actually asked",
  ...
  },
  {
    ...
    name: "Waiting for approval", description: "Stopped until somebody says yes",
  ...
  },
  {
    ...
    name: "Worker agent", description: "The one that does the task",
