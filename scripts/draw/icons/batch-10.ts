...
export const BATCH_10: Icon[] = [
...

  {
    ...
    name: "MCP server", description: "A server that exposes tools and data to a model",
  ...
  },
  {
    ...
    name: "MCP server add", description: "Connect another server",
  ...
  },
  {
    ...
    name: "MCP server check", description: "The server answered and is healthy",
  ...
  },
  {
    ...
    name: "MCP server alert", description: "Something is wrong with this server",
  ...
  },
  {
    ...
    name: "MCP server off", description: "The server is disabled",
...

  {
    ...
    name: "Document split", description: "One document, cut into pieces",
  ...
  },
  {
    ...
    name: "Chunk overlap", description: "The bit two chunks both contain",
...

  {
    ...
    name: "Serverless", description: "Code that runs without a machine you own",
  ...
  },
  {
    ...
    name: "Upload to cloud", description: "Send it up there",
  ...
  },
  {
    ...
    name: "Download from cloud", description: "Bring it back down",
...

  {
    ...
    name: "Inbox", description: "Where things arrive",
  ...
  },
  {
    ...
    name: "Archive", description: "Put away, not thrown away",
  ...
  },
  {
    ...
    name: "Integration", description: "Two systems that know about each other",
...

  {
    ...
    name: "History", description: "What happened before",
  ...
  },
  {
    ...
    name: "Report", description: "The numbers, written up",
...

  {
    ...
    name: "Sort ascending", description: "Smallest first",
  ...
  },
  {
    ...
    name: "Sort descending", description: "Largest first",
...

  {
    ...
    name: "Braces", description: "A block, or an object",
