...
export const BATCH_31: Icon[] = [
...

  {
    ...
    name: "Agent core", description: "The model at the middle of an agent",
  ...
  },
  {
    ...
    name: "Arbiter", description: "Who decides when agents disagree",
  ...
  },
  {
    ...
    name: "Approval step", description: "A step that waits for a person",
  ...
  },
  {
    ...
    name: "Assertion", description: "The claim a test makes",
...

  {
    ...
    name: "Image attachment", description: "A picture sent with the message",
  ...
  },
  {
    ...
    name: "Video attachment", description: "A clip sent with the message",
  ...
  },
  {
    ...
    name: "Attribution", description: "Which source a sentence came from",
  ...
  },
  {
    ...
    name: "Citation link", description: "The claim joined to what it rests on",
  ...
  },
  {
    ...
    name: "Container file", description: "The file that says how to build the image",
...

  {
    ...
    name: "Budget", description: "What is spent against what is allowed",
  ...
  },
  {
    ...
    name: "Autoscale", description: "More instances when there is more to do",
  ...
  },
  {
    ...
    name: "Config drift", description: "Two environments that no longer match",
  ...
  },
  {
    ...
    name: "Sankey chart", description: "Where the flow went",
...

  {
    ...
    name: "Add chunk", description: "One more piece into the index",
  ...
  },
  {
    ...
    name: "Chunk strategy", description: "Where to cut, and which way",
  ...
  },
  {
    ...
    name: "Cache build", description: "Fill it before anyone asks",
...

  {
    ...
    name: "Code block", description: "Code set apart from the prose",
  ...
  },
  {
    ...
    name: "Comparison", description: "This one against that one",
  ...
  },
  {
    ...
    name: "Consent", description: "Somebody said yes, on the record",
...

  {
    ...
    name: "API bridge", description: "One system reaching into another",
  ...
  },
  {
    ...
    name: "Audio generation", description: "Sound the model made",
