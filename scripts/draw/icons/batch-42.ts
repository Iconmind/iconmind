...
export const BATCH_42: Icon[] = [
...

  {
    ...
    name: "Lock", description: "A lock — closed to anyone without the key, secure and private",
  ...
  },
  {
    ...
    name: "Locked control", description: "A locked control — you can see it but not change it, disabled or read-only",
  ...
  },
  {
    ...
    name: "Grant permission", description: "Grant permission — from now on you may, access allowed and approved",
  ...
  },
  {
    ...
    name: "Passphrase", description: "A passphrase — longer than a password and easier to remember, several words as a secret",
  ...
  },
  {
    ...
    name: "PII", description: "PII — personally identifying data, information that is somebody",
...

  {
    ...
    name: "Filter step", description: "A filter step — only some of the items pass the condition and go on",
  ...
  },
  {
    ...
    name: "Filter result", description: "A filter result — what made it through the filter, the matching output",
  ...
  },
  {
    ...
    name: "Analytics filter", description: "An analytics filter — the slice of the data you are looking at, a segment narrowed down",
...

  {
    ...
    name: "Prompt stuffing", description: "Prompt stuffing — everything crammed into the context in case it helps",
  ...
  },
  {
    ...
    name: "Prompt analytics", description: "Prompt analytics — measuring which prompts work and which win",
  ...
  },
  {
    ...
    name: "Perplexity", description: "Perplexity — how surprised a model is by the text, a measure of uncertainty",
...

  {
    ...
    name: "Object store", description: "An object store — things kept by key name in a flat bucket rather than by place",
  ...
  },
  {
    ...
    name: "Private cloud", description: "A private cloud — cloud infrastructure that is yours alone, walled and dedicated",
  ...
  },
  {
    ...
    name: "Multi-cloud", description: "Multi-cloud — more than one provider at once, workloads across several clouds",
  ...
  },
  {
    ...
    name: "Monorepo", description: "A monorepo — every project in one repository under a single root",
...

  {
    ...
    name: "Map step", description: "A map step — the same operation applied to each item, fanned out in parallel",
  ...
  },
  {
    ...
    name: "Human in the loop", description: "Human in the loop — a person inside the cycle, reviewing before it continues",
...

  {
    ...
    name: "Consent record", description: "A consent record — who said yes, to what, and when, kept as proof",
  ...
  },
  {
    ...
    name: "Provenance", description: "Provenance — the whole story of where something came from, its chain of origin",
  ...
  },
  {
    ...
    name: "Content freshness", description: "Content freshness — is the knowledge still true, current and updated?",
