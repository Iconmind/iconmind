...
export const BATCH_128: Icon[] = [
  ...
  c("blood-pressure", "Blood pressure", "The cuff with its dial",
    ["pressure", "cuff", "bp"], ["bp"], ["blood pressure", "bp", "cuff", "sphygmomanometer"],
    "figure", [poly([[3, 8], [3, 17], [15, 17], [15, 8]], true), row(12.5, 3, 15), disc(19, 8, 3), poly([[19, 8], [21, 6]])]),
  ...
  c("x-ray", "X-ray", "The plate with a bone on it",
    ["x-ray", "scan", "bones"], ["radiograph"], ["x-ray", "radiograph", "bone scan", "chest x-ray"],
    "window", [rect(3, 3, 18, 18, 2), disc(8, 16, 2), disc(16, 8, 2), poly([[9.5, 14.5], [14.5, 9.5]])]),
  ...
  c("cast", "Plaster cast", "The arm in its cast",
    ["cast", "broken", "arm"], [], ["plaster cast", "broken arm", "cast", "fracture"],
    "figure", [poly([[7, 4], [7, 14], [13, 20], [17, 16], [11, 10], [11, 4]], true), row(9, 7, 11)]),
  ...
  c("toothbrush", "Toothbrush", "The handle with its bristles",
    ["toothbrush", "brush", "clean"], [], ["toothbrush", "brush your teeth", "oral care", "brush"],
    "figure", [poly([[3, 21], [12, 12]]), raw("M12 12L17 7A2.5 2.5 0 0 1 20.5 10.5L15.5 15.5A2.5 2.5 0 0 1 12 12Z", "the brush head", true), poly([[13, 10.5], [10.5, 8]]), poly([[16, 7.5], [13.5, 5]])]),
