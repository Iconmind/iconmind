...
export const BATCH_48: Icon[] = [
...

  {
    ...
    name: "Row", description: "A row — one record read across a table, every field for a single item",
  ...
  },
  {
    ...
    name: "Column", description: "A column — one attribute read down a table, the same field for every row",
  ...
  },
  {
    ...
    name: "Cell", description: "A cell — one value at exactly this row and column of a table",
  ...
  },
  {
    ...
    name: "Field", description: "A field — the box in a form that takes one answer from the person filling it in",
  ...
  },
  {
    ...
    name: "Variable", description: "A variable — a name with a value bound to it that can change as code runs",
  ...
  },
  {
    ...
    name: "Variant", description: "A variant — the same thing with one difference, an alternative version",
...

  {
    ...
    name: "Overlap", description: "Overlap — where both are true at once, the shared intersection",
  ...
  },
  {
    ...
    name: "Offset", description: "An offset — how far into a stream a consumer has read, the cursor position",
  ...
  },
  {
    ...
    name: "Layer", description: "A layer — one sheet of a stack, a level in a network or a design",
  ...
  },
  {
    ...
    name: "Ungroup", description: "Ungroup — let grouped objects be separate again so each can move on its own",
...

  {
    ...
    name: "Long-term memory", description: "Long-term memory — what survives the session, persistent and durable",
...

  {
    ...
    name: "Emoji", description: "An emoji — the feeling in one glyph, a face or a reaction in a message",
  ...
  },
  {
    ...
    name: "Image container", description: "An image container — the frame a picture arrives in, a media placeholder",
  ...
  },
  {
    ...
    name: "Media", description: "Media — pictures and sound together, audio, video and image files",
  ...
  },
  {
    ...
    name: "Communication", description: "Communication — both sides talking, messages exchanged back and forth",
...

  {
    ...
    name: "Object", description: "An object — named parts boxed together in braces, a struct or a record",
  ...
  },
  {
    ...
    name: "Blob", description: "A blob — bytes with no promised shape, opaque binary data stored as is",
...

  {
    ...
    name: "OCR ingest", description: "OCR ingest — scanned pages read into text and fed to the index",
  ...
  },
  {
    ...
    name: "Sanitise output", description: "Sanitise output — scrub a response clean before anyone sees it",
  ...
  },
  {
    ...
    name: "Producer", description: "A producer — the writer that puts messages on the queue for consumers to take",
