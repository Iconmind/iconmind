...
export const BATCH_75: Icon[] = [
  ...
  },
  {
    ...
    name: "Private bookmark", description: "A padlock beside a bookmark — a bookmark hidden from others",
  ...
  },
  {
    ...
    name: "Locked filter", description: "A padlock beside a funnel — a filter users cannot remove",
  ...
  },
  {
    ...
    name: "Run scan", description: "A shield beside a play button — start a security scan",
  ...
  },
  {
    ...
    name: "Protected goal", description: "A shield beside a target — a goal guarded from interference",
  ...
  },
  {
    ...
    name: "Key share", description: "A key beside an arrow — share a credential with someone",
  ...
  },
  {
    ...
    name: "Bookmark label", description: "A bookmark beside a label — a bookmark filed under a tag",
  ...
  },
  {
    ...
    name: "Saved policy", description: "A bookmark beside a shield — a policy saved for reuse",
  ...
  },
  {
    ...
    name: "Liked", description: "A heart with a check beside it — something you liked",
  ...
  },
  {
    ...
    name: "Favourite label", description: "A heart beside a label — favourites grouped under a name",
  ...
  },
  {
    ...
    name: "Tag alert", description: "A label beside an alert mark — a tag that needs attention",
  ...
  },
  {
    ...
    name: "Add location", description: "A location pin with a plus beside it — add a new place",
  ...
  },
  {
    ...
    name: "Archived list", description: "A list beside a Z — a list put to rest in the archive",
...

  {
    ...
    name: "Labelled checkpoint", description: "A flag beside a label — a checkpoint with a name",
  ...
  },
  {
    ...
    name: "Next milestone", description: "A flag with a double chevron beside it — on to the next milestone",
  ...
  },
  {
    ...
    name: "Remove checkpoint", description: "A flag with a minus beside it — delete a checkpoint",
  ...
  },
  {
    ...
    name: "Model idle", description: "A model core beside a Z — a model loaded but doing nothing",
...

  {
    ...
    name: "Run idle", description: "A play button beside a Z — a runner with nothing to do",
  ...
  },
  {
    ...
    name: "Add run", description: "A play button with a plus beside it — queue another run",
  ...
  },
  {
    ...
    name: "Collapse block", description: "Two chevrons closing inside brackets — fold a block of code",
  ...
  },
  {
    ...
    name: "Labelled block", description: "A label held between brackets — a block of code with a name",
  ...
  },
  {
    ...
    name: "Remove trigger", description: "A lightning bolt with a minus beside it — delete a trigger",
  ...
  },
  {
    ...
    name: "Remove goal", description: "A target with a minus beside it — drop a goal",
  ...
  },
  {
    ...
    name: "Paid milestone", description: "A coin beside a flag — a milestone that releases a payment",
  ...
  },
  {
    ...
    name: "Favourite bookmark", description: "A heart beside a bookmark — a saved item you love",
  ...
  },
  {
    ...
    name: "Time alert", description: "A clock beside an alert mark — a time-based warning",
  ...
  },
  {
    ...
    name: "Landing page", description: "A window with a flag inside — the page a visitor lands on",
  ...
  },
  {
    ...
    name: "Favourite page", description: "A window with a heart inside — a page marked as a favourite",
