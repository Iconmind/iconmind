...
export const BATCH_43: Icon[] = [
...

  {
    ...
    name: "Workflow run", description: "Workflow run — the flow is going, started and active right now",
  ...
  },
  {
    ...
    name: "Workflow pause", description: "Workflow pause — the flow held where it is, suspended and waiting",
  ...
  },
  {
    ...
    name: "Workflow stop", description: "Workflow stop — the flow ended before its end, cancelled or killed",
  ...
  },
  {
    ...
    name: "Workflow fail", description: "Workflow fail — the flow broke partway, an error turned it red",
  ...
  },
  {
    ...
    name: "New workflow", description: "New workflow — start a flow from nothing with an empty canvas",
  ...
  },
  {
    ...
    name: "Workflow template", description: "A workflow template — a starter flow with the blanks still in it",
...

  {
    ...
    name: "Tool result", description: "A tool result — what the tool handed back to the agent after it was called",
  ...
  },
  {
    ...
    name: "Tool error", description: "A tool error — the tool broke instead of answering, an exception",
  ...
  },
  {
    ...
    name: "Tool permission", description: "Tool permission — may the agent use this tool? A consent gate",
...

  {
    ...
    name: "Secret vault", description: "A secret vault — where the keys themselves are kept sealed and safe",
  ...
  },
  {
    ...
    name: "Secret config", description: "Secret config — settings too sensitive for the repo, hidden environment values",
  ...
  },
  {
    ...
    name: "Zero trust", description: "Zero trust — nobody is inside by default, every request verified",
...

  {
    ...
    name: "Vector query", description: "A vector query — asking the index what is nearest to this embedding",
  ...
  },
  {
    ...
    name: "Vector upsert", description: "Vector upsert — write new or updated vectors into the index in one operation",
  ...
  },
  {
    ...
    name: "Similarity search", description: "Similarity search — find what is most like this one, the nearest neighbours",
  ...
  },
  {
    ...
    name: "Sparse search", description: "Sparse search — match the words themselves, lexical and exact",
...

  {
    ...
    name: "Vision model", description: "A vision model — a model that looks at images and understands what it sees",
  ...
  },
  {
    ...
    name: "Video generation", description: "Video generation — moving pictures that never happened, a clip made by a model",
  ...
  },
  {
    ...
    name: "Speech", description: "Speech — sound with words in it, a spoken voice recorded or generated",
...

  {
    ...
    name: "Session", description: "A session — signed in for now, an active window of use until you leave",
  ...
  },
  {
    ...
    name: "State", description: "State — what is true right now, a snapshot of the current values",
  ...
  },
  {
    ...
    name: "Working memory", description: "Working memory — what a model or agent is holding while it thinks",
